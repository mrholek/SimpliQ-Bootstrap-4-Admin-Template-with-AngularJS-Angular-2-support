...
angular
    ...
    .controller('cardChartCtrl14', cardChartCtrl14)
...
function toastrWelcome($scope, toastr) {
    toastr.info('Bootstrap 4 Admin Template', 'Welcome to SimpliQ Admin', {
        closeButton: true,
        progressBar: true,
    });
}
...
function mainChartCtrl($scope){
	...
	var data = [1, 2, 3, 4, 5, 4, 3, 3, 4, 5, 5, 6, 6, 5, 5, 4, 6, 5, 4, 3, 2, 1, 2, 2, 3, 4, 5, 6, 5, 4, 3, 2];
...
cardChartCtrl14.$inject = ['$scope'];
function cardChartCtrl14($scope){
